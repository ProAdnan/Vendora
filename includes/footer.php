        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        <li class="mb-2"><i class="bi bi-geo-alt me-2"></i> Jordan, Amman</li>
                        <li class="mb-2"><i class="bi bi-envelope me-2"></i> Vendora@gmail.com</li>
                        <li class="mb-2"><i class="bi bi-telephone me-2"></i> +962 780632320</li>
                    </ul>
                </div>
            </div>
