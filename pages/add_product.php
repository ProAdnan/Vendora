...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top border-bottom">
        <div class="container">
            ...
            <div class="ms-auto">
                <a href="admin_dashboard.html" class="btn btn-outline-secondary btn-sm">Cancel</a>
            </div>
        </div>
    </nav>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button type="submit" class="btn btn-primary-custom px-4">Publish Product</button>
                    </div>

                    <div class="card card-custom p-4 border-0">
                        <div class="mb-3">
                            <label class="form-label fw-bold small text-muted">Product Name</label>
                            <input type="text" class="form-control form-control-lg" placeholder="e.g. Nike Air Max"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="6"
                                placeholder="Describe the product features, specs, and benefits..."></textarea>
                        </div>

                        <div class="form-check text-muted small">
                            <input class="form-check-input" type="checkbox" id="feature" checked>
